            ...
            ScrollView {
                VStack(spacing: 16) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        FeatureButton(title: "Standard Row Features", feature: .standardRowFeatures, color: accentColor) {
                        ...
                        FeatureButton(title: "Row Sorting with Drop Target", feature: .rowSortingWithDropTarget, color: accentColor) {
